...
const CreditCardOutlineIcon = ({ size = 24, color, className, ...rest }: IconProps) => (
  <svg
    width={size}
    height={size}
  ...
  >
    ...
    <path d="M7 15h4a1 1 0 0 0 0-2H7a1 1 0 0 0 0 2" />
    <path d="M15 15h2a1 1 0 0 0 0-2h-2a1 1 0 0 0 0 2" />
  </svg>
)
