...
const FlagRussiaIcon = ({ size = 24, color, className, ...rest }: IconProps) => (
  <svg
    width={size}
    height={size}
  ...
  >
    <rect width={24} height={24} fill="url(#pattern0_10351_21214)" />
    <defs>
      <pattern id="pattern0_10351_21214" patternContentUnits="objectBoundingBox" width={1} height={1}>
        <use xlinkHref="#image0_10351_21214" transform="scale(0.0138889)" />
      </pattern>
      <image
        id="image0_10351_21214"
        width={72}
        height={72}
