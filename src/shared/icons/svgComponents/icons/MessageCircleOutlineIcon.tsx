...
const MessageCircleOutlineIcon = ({ size = 24, color, className, ...rest }: IconProps) => (
  <svg
    width={size}
    height={size}
  ...
  >
    ...
    <path d="M16 13a1 1 0 1 0 0-2 1 1 0 0 0 0 2" />
    <path d="M8 13a1 1 0 1 0 0-2 1 1 0 0 0 0 2" />
