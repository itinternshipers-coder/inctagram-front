...
import './TextPageLayout.module.scss'
...
// 1. Настройка Storybook (Meta)
const meta: Meta<typeof TextPageLayout> = {
  title: 'Components/TextPageLayout',
  component: TextPageLayout,
  tags: ['autodocs'],
  parameters: {
    // Настройки для центрирования или отображения в определенном контейнере
    layout: 'fullscreen',
  },
  args: {
    // Аргументы по умолчанию для всех историй
    backHref: '/profile',
    children: <div style={{ whiteSpace: 'pre-line' }}>{LONG_TEXT.trim()}</div>,
  },
}

export default meta
type Story = StoryObj<typeof TextPageLayout>
