...
const FlagUnitedKingdomIcon = ({ size = 24, color, className, ...rest }: IconProps) => (
  <svg
    width={size}
    height={size}
  ...
  >
    <rect width={24} height={24} fill="url(#pattern0_40511_400)" />
    <defs>
      <pattern id="pattern0_40511_400" patternContentUnits="objectBoundingBox" width={1} height={1}>
        <use xlinkHref="#image0_40511_400" transform="scale(0.0138889)" />
      </pattern>
      <image
        id="image0_40511_400"
        width={72}
...
export default FlagUnitedKingdomIcon
